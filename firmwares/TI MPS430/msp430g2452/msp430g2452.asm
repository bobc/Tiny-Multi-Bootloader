...
IdTypeMSP430	.equ	0x44		; must exists in "piccodes.ini"
FamilyMSP430	.equ	0x34		; LPC Family "4"

max_flash	.equ	0x2000		; in bytes, not WORDS!!!
...
;   The above 12 lines can be changed and buid a bootloader for the desired frequency (and PIC type)
...
rxd		.equ	R15
    	...
    	;********************************************************************
    	;       Tiny Bootloader   MSP430G2X12 MSP430G2X52   Size=136+192bytes
	;
	...
	;
	;	$41, 4, MSP430 G2152,   $400,   0,     136, 64,
	;	$41, 4, MSP430 G2112,   $400,   0,     136, 64,
	;	$42, 4, MSP430 G2252,   $800,   0,     136, 64,
	;	$42, 4, MSP430 G2212,   $800,   0,     136, 64,
	;	$43, 4, MSP430 G2352,   $1000,  0,     136, 64,
	;	$43, 4, MSP430 G2312,   $1000,  0,     136, 64,
	;	$44, 4, MSP430 G2452,   $2000,  0,     136, 64,
	;	$44, 4, MSP430 G2412,   $2000,  0,     136, 64,
	;
	;********************************************************************
