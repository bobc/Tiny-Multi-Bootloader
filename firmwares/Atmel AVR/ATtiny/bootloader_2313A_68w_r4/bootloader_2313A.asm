...
.equ	IdTypeAVR=0x18		; must exists in "piccodes.ini"	
#define	max_flash 0x400		; in WORDS, not bytes!!! (= 'max flash memory' from "piccodes.ini" divided by 2)
...
; +---------+---------+------------+------------+------------+-----------+--------+------+
; |   0x31  |   0x18  |TN2313A(68W)|  16 words  |  16 words  |  0x0400   |  128   |  20  |
; +---------+---------+------------+------------+------------+-----------+--------+------+

    	;********************************************************************
    	;       Tiny Bootloader         ATTINY2313A              Size=68words
	;
	...
	;
	;	$18, 1, ATTINY 2313A, $800, 128, 136, 32,
	;
	;********************************************************************
