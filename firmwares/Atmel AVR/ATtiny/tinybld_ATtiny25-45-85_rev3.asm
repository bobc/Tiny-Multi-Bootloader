...
.equ	Calib   =	0x5E    ; 8MHz Calibration value

        #define EEPSZ   512	        ; EEPROM Size(128/256/512)
        #define TX	4		; ATTINY13A RX Data input pin (i.e. 3 = PORTB,3)
...
;   The above 12 lines can be changed and buid a bootloader for the desired frequency

; +---------+---------+--------+------------+------------+-----------+------+--------+------+
; |AVRFamily|IdTypePIC| Device | Erase_Page | Write_Page | max_flash | PORT | EEPROM | PDIP |
; +---------+---------+--------+------------+------------+-----------+------+--------+------+
; |   0x31  |   0x14  |  TN25  |  16 words  |  16 words  |  0x0400   |   B  |  128   |   8  |
; |   0x31  |   0x15  |  TN45  |  32 words  |  32 words  |  0x0800   |   B  |  256   |   8  |
; |   0x31  |   0x16  |  TN85  |  32 words  |  32 words  |  0x1000   |   B  |  512   |   8  |
; +---------+---------+--------+------------+------------+-----------+------+--------+------+

    	;********************************************************************
    	;       Tiny Bootloader         ATTINY25/45/85		Size=100words
	;
	;	(2014.08.11 Revision 3)
	;	This program is only available in Tiny_Avr-Pic_Bootloader+
	;
