...
.equ	IdTypeAVR=0x24		; must exists in "piccodes.ini"	
...
.equ	Calib   =	0x94	; 8MHz Calibration value
...
; +---------+---------+--------+------------+------------+-----------+--------+------+
; |   0x32  |   0x24  | M168A  |  64 words  |  64 words  |  0x2000   |  512   |  28  |
; +---------+---------+--------+------------+------------+-----------+--------+------+

    	;********************************************************************
    	;       Tiny Bootloader         ATMEGA168A              Size=132words
	;
	...
	;
	;	$24, 2, ATMEGA 168A, $4000, 512, default, default,
	;
	;********************************************************************
