	; modifications suggested by Jacques Moulin for the 16F873/74
	;
...
IdTypePIC = 0x32			; must exists in "piccodes.ini"	
...
mainl
	...
	bsf	STATUS,RP0			; added for 16F873/4
	movwf	flag				;
...
writeloop						; write 2 bytes = 1 instruction
	...
	incf	FSR	
		BANK3_					;bank  2->3
	bcf		EECON1,EEPGD
	;btfsc	flag,6			;only FLASH write (no more eeprom write)
	;bsf		EECON1,EEPGD
	bsf		EECON1,WREN
	movlw	0x55
	movwf	EECON2
