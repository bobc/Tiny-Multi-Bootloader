...
#include "p16f887.inc"
IdTypePIC = 0x36			; must exists in "piccodes.ini"			
...
; we'll use BRG16, 8Mhz, so:
spbrg_value EQU 16

	#include "../bankswitch.inc"
	#define first_address max_flash-100 ; 100 word in size

	__CONFIG    _CONFIG1, _LVP_OFF & _FCMEN_OFF & _IESO_ON & _BOR_OFF & _CPD_OFF & _CP_OFF & _MCLRE_ON & _PWRTE_ON & _WDT_OFF & _INTRC_OSC_NOCLKOUT
; Other options:
;_WDT_OFF           
;_LP_OSC            
;_XT_OSC            
...
IntrareBootloader
	...
	bsf		OSCCON, IRCF0		; added to work with 8MHz...
	bsf		OSCCON, SCS			;??
