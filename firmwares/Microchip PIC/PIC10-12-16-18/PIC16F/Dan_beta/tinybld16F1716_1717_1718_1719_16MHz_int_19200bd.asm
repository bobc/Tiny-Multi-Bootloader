...
rxPPS		EQU	0		; Serial RX Pin select, Please refer to the table below
txPPS		EQU	1		; Serial TX Pin select, Please refer to the table below
...
; +---------+--------+------------+------------+--------+-----------+--------+------+
; |   0x27  |16F1713 |  32 words  | PORTA(PPS) | C7(18) |  0x1000   |    0   |  28  |
; |   0x29  |16F1716 |  32 words  | PORTA(PPS) | C7(18) |  0x2000   |    0   |  28  |
; |   0x29  |16F1717 |  32 words  |PORTA/D(PPS)| C7(26) |  0x2000   |    0   |  40  |
; |   0x2B  |16F1718 |  32 words  | PORTA(PPS) | C7(18) |  0x4000   |    0   |  28  |
; |   0x2B  |16F1719 |  32 words  |PORTA/D(PPS)| C7(26) |  0x4000   |    0   |  40  |
; +---------+--------+------------+------------+--------+-----------+--------+------+
...
;+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+
        ...
        ;********************************************************************
	;	Tiny Bootloader		16F171x series		Size=100words
...
IntrareBootloader:
	...
	clrf	ANSELA			;ANSELA
 #endif
 #if ((txPPS/8==3) | (rxPPS/8==3))
	clrf	ANSELA+3		;ANSELD
 #endif
