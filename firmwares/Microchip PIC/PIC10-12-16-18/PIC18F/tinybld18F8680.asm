...
IdTypePIC = 0x4D			; must exists in "piccodes.ini"
#define max_flash 0x10000	; in BYTES!!! (= 'max flash memory' from "piccodes.ini")
	;xtal EQU 4*8000000		; you may want to change: CONFIG OSC = ...
...
#define baud 115200
	...
	; The above lines can be changed and buid a bootloader for the desired frequency (and PIC type)
