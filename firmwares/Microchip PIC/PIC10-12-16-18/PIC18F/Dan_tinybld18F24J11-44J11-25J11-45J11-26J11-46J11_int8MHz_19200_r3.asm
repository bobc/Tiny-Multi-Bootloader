...
IdTypePIC = 0x31		; Please refer to the table below, must exists in "piccodes.ini"	
#define max_flash  0x8000	; in bytes, not WORDS!!! , Please refer to the table below
...
; +---------+--------+------------+------------+-------------+-------------+-----------+--------+------+
; |   0x30  |18F24J11|  32 words  |  512 words |    C6(17)   |    C7(18)   |   0x4000  |   0    |  28  |
; |   0x30  |18F44J11|  32 words  |  512 words |    C6(25)   |    C7(26)   |   0x4000  |   0    |  40  |
; |   0x31  |18F25J11|  32 words  |  512 words |    C6(17)   |    C7(18)   |   0x8000  |   0    |  28  |
; |   0x31  |18F45J11|  32 words  |  512 words |    C6(25)   |    C7(26)   |   0x8000  |   0    |  40  |
; |   0x32  |18F26J11|  32 words  |  512 words |    C6(17)   |    C7(18)   |   0x8000  |   0    |  28  |
; |   0x32  |18F46J11|  32 words  |  512 words |    C6(25)   |    C7(26)   |   0x8000  |   0    |  40  |
; +---------+--------+------------+------------+-------------+-------------+-----------+--------+------+
...
;max_flash	+---------------+ 0x200	+---------------+	+---------------+	+---------------+
        ...
        ;********************************************************************
	;	Tiny Bootloader		18F2XJ11/18F4XJ11 	Size=132words
        ;       claudiu.chiculita@ugal.ro
        ;       http://www.etc.ugal.ro/cchiculita/software/picbootloader.htm
	;	(2013.11.18 Revision 3)
	;
	...
	#include "../spbrgselect.inc"	; RoundResult and baud_rate
		...
		#define first_address max_flash-264		;132 words
			...
			config LPT1OSC = OFF		;Low-Power Timer1 Oscillator:High-power operation
			...
			config IOL1WAY = OFF		;IOLOCK bit (PPSCON<0>) can be set and cleared as needed, provided the unlock sequence has been completed
			...
			config WPEND = PAGE_0		;Page 0 through WPFP<5:0> erase/write protected
...
IntrareBootloader:
						;skip TRIS to 0 C6
	bsf	OSCCON,IRCF0			;int clock 8MHz
...
wr_bl1:						;TBLPTR = 0x003B00-1(18F24/44J11)
	rcall 	wr_bld				;TBLPTR = 0x007B00-1(18F25/45J11)
	bra	(wr_bl2 - 1024)			;TBLPTR = 0x00FB00-1(18F26/46J11)
wr_bl2:						;TBLPTR = 0x003F00-1(18F24/44J11)
	rcall 	wr_bld				;TBLPTR = 0x007F00-1(18F25/45J11)
	bra	(set_FSR + 1024)		;TBLPTR = 0x00FF00-1(18F26/46J11)
set_FSR:
	decf	FSR0H				;FSR0 = 0x0100
...
;;	rrcf	flagU
	...
	movlw	((IntrareBootloader>>10)&0xFF)	;0x0F=0x3C00>>10,0x1F=0x7C00>>10,0x3F=0xFC00>>10
	subwf	flagH,w
