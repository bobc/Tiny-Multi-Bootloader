...
#define USE_INTOSC		; change frequency at line 131. Comment this line if you use an external Quartz!
...
;	This source file is for PIC18F2585, 2680, 4585, and 4680.
...
;		CONFIG	OSC = HS, FCMEN = OFF, IESO = OFF
		CONFIG	OSC = IRCIO67, FCMEN = OFF, IESO = OFF	; Use internal oscilator, xtal = 8000000

;----- CONFIG2L Options -----
		CONFIG	PWRT = ON, BOREN = BOHW, BORV = 2
