...
#define max_flash  0x4000	; in bytes, not WORDS!!! (= 'max flash memory' from "piccodes.ini" divided by 2), Please refer to the table below
#define	Write_Page 8	        ; Write Page          (4/8), Please refer to the table below
...
; +---------+--------+------------+------------+-------------+-------------+-----------+--------+------+
; |   0x61  |18F13K50|   4 words  |  32 words  |    B7(10)   |    B5(12)   |  0x2000   |   256  |  20  |
; |   0x62  |18F14K50|   8 words  |  32 words  |    B7(10)   |    B5(12)   |  0x4000   |   256  |  20  |
; +---------+--------+------------+------------+-------------+-------------+-----------+--------+------+

        ;********************************************************************
	;	Tiny Bootloader		18F13K50/18F14K50 	Size=100words
        ;       claudiu.chiculita@ugal.ro
        ;       http://www.etc.ugal.ro/cchiculita/software/picbootloader.htm
	;
	;	(2013.08.28 Revision 4)
	;
