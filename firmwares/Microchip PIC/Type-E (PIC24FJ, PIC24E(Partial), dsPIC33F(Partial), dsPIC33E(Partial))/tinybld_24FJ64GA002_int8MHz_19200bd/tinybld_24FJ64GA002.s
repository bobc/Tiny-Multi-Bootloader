...
.equ max_flash, 0xAC00		; dsPIC max address, not bytes!!! (= 'max flash memory' from "piccodes.ini" divided by 2), Please refer to the table below
...
; +---------+-------------+------------+------------+-------------+--------------+-----------+--------+-------+
; |   0xA0  | 24FJ16GA002 |  64 instr. | 512 instr. |  RP0~RP15   | RP0~RP15,Vss |   0x2C00  |   0    |   2   |
; |   0xA0  | 24FJ16GA004 |  64 instr. | 512 instr. |  RP0~RP25   | RP0~RP25,Vss |   0x2C00  |   0    |   2   |
; |   0xA1  | 24FJ32GA002 |  64 instr. | 512 instr. |  RP0~RP15   | RP0~RP15,Vss |   0x5800  |   0    |   2   |
; |   0xA1  | 24FJ32GA004 |  64 instr. | 512 instr. |  RP0~RP25   | RP0~RP25,Vss |   0x5800  |   0    |   2   |
; |   0xA2  | 24FJ48GA002 |  64 instr. | 512 instr. |  RP0~RP15   | RP0~RP15,Vss |   0x8400  |   0    |   2   |
; |   0xA2  | 24FJ48GA004 |  64 instr. | 512 instr. |  RP0~RP25   | RP0~RP25,Vss |   0x8400  |   0    |   2   |
; |   0xA3  | 24FJ64GA002 |  64 instr. | 512 instr. |  RP0~RP15   | RP0~RP15,Vss |   0xAC00  |   0    |   2   |
; |   0xA3  | 24FJ64GA004 |  64 instr. | 512 instr. |  RP0~RP25   | RP0~RP25,Vss |   0xAC00  |   0    |   2   |
; +---------+-------------+------------+------------+-------------+--------------+-----------+--------+-------+
...
.ENDIF
        ...
        ;********************************************************************
	;	Tiny Bootloader				 	Size=132words
	;	 24FJ12GA002/4, 24FJ24GA002/4, 24FJ48GA002/4, 24FJ64GA002/4
...
config          __CONFIG2, POSCMOD_NONE & I2C1SEL_PRI & IOL1WAY_OFF & OSCIOFNC_ON & FCKSM_CSDCMD & FNOSC_FRC & SOSCSEL_SOSC & WUTSEL_LEG & IESO_OFF
config          __CONFIG1, WDTPS_PS1 & FWPSA_PR32 & WINDIS_OFF & FWDTEN_OFF & ICS_PGx1 & COE_OFF & BKBUG_OFF & GWRP_OFF & GCP_OFF & JTAGEN_OFF
...
.IF (max_flash == 0x2C00)
	mov 	#0x0A00,W0			;0x0A00 = ((0x2C00 - 512*2)>>2)&0xFFFF
.ENDIF
.IF (max_flash == 0x5800)
	mov 	#0x1500,W0			;0x1500 = ((0x5800 - 512*2)>>2)&0xFFFF
.ENDIF
.IF (max_flash == 0x8400)
	mov 	#0x2000,W0			;0x2000 = ((0x8400 - 512*2)>>2)&0xFFFF
.ENDIF
.IF (max_flash == 0xAC00)
